  ...
  return <div className="canvas fu">
    ...
    <div className="card">
      ...
      <div style={{fontSize:11,color:"var(--ink3)",marginTop:9,lineHeight:1.55}}>
        When opened through <strong style={{color:"var(--leaf)"}}>node scripts\serve.mjs</strong>, data also syncs to <strong style={{color:"var(--ink2)"}}>data/app-state.json</strong> in this folder. Double-click mode still uses browser localStorage only.<br/>
